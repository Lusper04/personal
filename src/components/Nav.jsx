    ...
    <div id="About" className="flex justify-center mb-[40vh] scroll-smooth ">
      <div className="w-fit relative top-11 inset-x-0 mx-auto border border-white/[0.3] rounded-full backdrop-blur-sm z-[5000] transform-none px-4 py-3 shadow-2xl">
        ...
        <div className="relative hidden md:flex flex-row justify-center items-center gap-10 font-[sans-serif] transition duration-300 ease-in-out">
          ...
          <button className="relative flex items-center space-x-1 text-neutral-50 group hover:text-[#009966]" onClick={() => handleScroll("Education")}>Education</button>
          <button className="relative flex items-center space-x-1 text-neutral-50 group hover:text-[#009966]" onClick={() => handleScroll("Services")}>Services</button>
          <button className="relative flex items-center space-x-1 text-neutral-50 group hover:text-[#009966]" onClick={() => handleScroll("Experiences")}>Expriences</button>
          <button className="relative flex items-center space-x-1 text-neutral-50 group hover:text-[#009966]" onClick={() => handleScroll("Skills")}>Skills</button>
          <button className="relative flex items-center space-x-1 text-neutral-50 group hover:text-[#009966]" onClick={() => handleScroll("Projects")}>Projects</button>
          <button className="relative flex items-center space-x-1 text-neutral-50 group hover:text-[#009966]" onClick={() => handleScroll("Contact")}>Contact</button>
        </div>
